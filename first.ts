...
var p_name: string = "aTiSaM aKhTaR";
...
const author:string = "Rich Dad";
const quote:string = "Financial struggle is often the result of people working all their lives for someone else";

console.log(`${author} once said, "${quote}" `);

// ***** 5th question

let famous_person:string = "Robert Toru Kiyosaki";
